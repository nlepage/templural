...
test('Build categories', t => {
  ...
  t.deepEqual(buildCategories(new Intl.PluralRules('fr')), [['other'], ['one', 'other'], ['one', 'other', 'many']])
  t.deepEqual(buildCategories(new Intl.PluralRules('fr'), { categoriesOrder: ['many', 'one', 'other'] }), [['other'], ['one', 'other'], ['many', 'one', 'other']])
